...
\item[] S.S. Merchant (Presenting), W.H. Green, K.M. Van Geem, N.
        Hansen, \textbf{B.W. Weber}, C.J. Sung. \textit{Combustion of 
        the Butanol Isomers: Reaction Pathways from High to Low
        Temperature.} \ordinalnum{8} International Conference on
        Chemical Kinetics, University Seville, Seville, Spain, July
        2013.

\item[] \textbf{ B.W. Weber}, W.J. Pitz, C.J. Sung, M. Mehl,
        E.J. Silke, A.C. Davis. \textit{Experiments and Modeling of the
        Autoignition of Methyl-Cyclohexane at High Pressure.}
...
\item[] S.M. Sarathy, S. Park, W. Wang, P. Veloo, A.C. Davis,
        ...
        W.J. Pitz, C.J. Sung, P. Dagaut. \textit{A Comprehensive
...
\item[] M.R. Harper, W.H. Green (Presenting), K.M. Van Geem,
        ...
        R.K. Hanson. \textit{Combustion of the butanol isomers:
...
\begin{outerlist}
    \item[] Spring 2013 -- Instructor for ENGR~1166: Introduction to
        ...
        \begin{innerlist}
            ...
            \item[] Lecture notes and sample homework problems are
   ...
   \item[] Fall 2012 -- Teaching Assistant for ME~3239: Combustion for
        ...
        \begin{innerlist}
            ...
            \item Designed in-depth projects to explore combustion 
                  modeling using the CHEMKIN--Pro software
...
\begin{lonelist}
   \item[] \textbf{Combustion Energy Frontier Research Center} \hfill 
           2012-Present\\
           \textbf{Co-chair, Junior Associates Committee}
   \begin{innerlist}
