...
Three-time recipient of University of Connecticut Provost's Teaching Commendation (Spring 2016, Fall 2016, Spring 2017)
...
\begin{innerlist}
    \item Spring 2018: 60 students (1 section)
\end{innerlist}

\item ME 4972/4973W: Senior Capstone Design Project Co-Instructor/Team Mentor \hfill 2014--2018
\begin{innerlist}
    \item Mentoring up to 4 teams per year of 2-4 students working on an industrially-sponsored capstone design project
    \item Giving lectures for the class of up to 162 students on technical presentations, data analysis, and data visualization
...
\begin{innerlist}
    \item Supervised 5 students conducting research (Summer 2017: 2, Fall 2017: 3), including a \ordinalnum{12}-grade student at E.O. Smith High School
...
\begin{innerlist}
    ...
    \item Developing open-source tools to enhance student engagement and learning
    ...
    \item Developing open-source tools to improve reproducibility in experimental work
\end{innerlist}
...
\begin{lonelist}
\item[] \org{Mechanical Engineering Department, University of Connecticut} \hfill 2017--Present\\
\position{Member, ABET Planning Committee}

\begin{innerlist}
    \item Planning for 2019 ABET Accreditation visit
    \item Developing tests to evaluate student pre- and post-course learning objective retention
    \item Collecting course materials to demonstrate student outcomes
\end{innerlist}
\end{lonelist}
...
\section{{\sectionfont Other Service}}
